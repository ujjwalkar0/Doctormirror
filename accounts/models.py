...
class doctors(models.Model):
    ...
    MBBS=models.BooleanField()
    BMBS=models.BooleanField()
    MBChB=models.BooleanField()
    MBBCh=models.BooleanField()
    MD=models.BooleanField()
    Dr.MuD=models.BooleanField()
    Dr.Med=models.BooleanField()
    DO=models.BooleanField()
    MD_res=models.BooleanField()
    PhD=models.BooleanField()
    DPhill=models.BooleanField()
    MCM=models.BooleanField()
    MMSc=models.BooleanField()
    MMedSc=models.BooleanField()
    MM=models.BooleanField()
    MMed=models.BooleanField()
    MPhil=models.BooleanField()
    MS=models.BooleanField()
    MSurg=models.BooleanField()
    MChir=models.BooleanField()
    MCh=models.BooleanField()
    ChM=models.BooleanField()
    CM=models.BooleanField()
    MSc=models.BooleanField()
    DCM=models.BooleanField()
    DClinSurg=models.BooleanField()
    DMSc=models.BooleanField()
    DMedSc=models.BooleanField()
    DS=models.BooleanField()
    DSurg=models.BooleanField()
